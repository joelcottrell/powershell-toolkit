<#
.NOTES
    Filename: Detect-LocalAdminAccount.ps1
    Version: 1.0
...
.PROJECTURI
https://github.com/joelcottrell/powershell-toolkit/tree/main/Endpoint/Intune/Windows/ProactiveRemediations/Create-LocalAdminAccount
