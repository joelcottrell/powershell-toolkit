...
.PROJECTURI
https://github.com/joelcottrell/powershell-toolkit/tree/main/Endpoint/Intune/Windows/ProactiveRemediations/Clear-MicrosoftAppsCache
...
.SYNOPSIS
Script to clean Up Microsoft 365 Apps Cache

.DESCRIPTION
This script attempts to clear the Microsoft 365 Apps cache on demand with Intune, potentially resolving various app-related problems.
...
# Start Powershell Transcript and define variables
