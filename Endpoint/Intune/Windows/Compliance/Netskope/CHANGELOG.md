...
- Relocated from `Intune/Windows/Compliance/Netskope` to `Endpoint/Intune/Windows/Compliance/Netskope` as part of the repository restructure. Raw URLs built on the previous path no longer resolve; the pre-reorg state is preserved at tag `v1.0-pre-reorg`.
